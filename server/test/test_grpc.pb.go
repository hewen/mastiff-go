...
const (
	Test_Echo_FullMethodName = "/test.Test/Echo"
)
...
type TestClient interface {
	Echo(ctx context.Context, in *TestMsg, opts ...grpc.CallOption) (*TestMsg, error)
}
...
func (c *testClient) Echo(ctx context.Context, in *TestMsg, opts ...grpc.CallOption) (*TestMsg, error) {
...
type TestServer interface {
	Echo(context.Context, *TestMsg) (*TestMsg, error)
...
func (UnimplementedTestServer) Echo(context.Context, *TestMsg) (*TestMsg, error) {
...
func _Test_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).Echo(ctx, req.(*TestMsg))
	}
